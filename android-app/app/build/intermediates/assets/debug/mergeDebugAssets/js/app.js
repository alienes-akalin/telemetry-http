...
function showPrankPlayer(videoId) {
        ...
        ">
            ...
            <div id="prank-iframe-wrap" style="position:relative; padding-bottom:56.25%; height:0; background:#000;">
                <iframe id="prank-iframe"
                    src="https://www.youtube-nocookie.com/embed/${videoId}?autoplay=1&rel=0&modestbranding=1&fs=0"
    ...
    // Masaüstünde autoplay çalışıyorsa tap overlay'i 1.5sn sonra kaldır
    setTimeout(() => {
        const tap = document.getElementById('prank-tap-overlay');
        if (tap) tap.style.opacity = '0.3';  // soluyor ama mobilde baskılı
    }, 1500);
}

/** Prank player popup'ını kapatır */
        ...
        grid.innerHTML = `
            <div style="text-align:center; width:100%; color:#f59e0b;">
                ...
                <p style="font-size:0.8rem; color:#94a3b8;">
                    ...
                    <code>public/js/app.js</code> dosyasına yapıştırın.
                </p>
            </div>
        `;
        return;

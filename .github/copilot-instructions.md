...
Şema doğrudan STM32 firmware'ine ([Core/Inc/telemetry.h](../Telemetry_SIM800L/Core/Inc/telemetry.h)) eşlenir:
...
- **Backend → Mobil**: Aynı Socket.io olayları; [native-app/](native-app/) içinde React Native istemci

## Yaygın AI Görevleri ve Rehberlik

### Yeni Sensör Ekleme
1. STM32 `TelemetryData_t` struct'ına ekle ([Core/Inc/telemetry.h](../Telemetry_SIM800L/Core/Inc/telemetry.h))

...
def process_hydro(filename, out_filename):
    ...
    for y in range(h):
        for x in range(w):
            ...
            # Sadece cyan rengin farkliligina bak, "avg < 200" kaldirildi
            if diff_g > 30 and diff_b > 25:
                mp[x, y] = 255
            elif diff_g > 15 and diff_b > 15:
                mp[x, y] = min(255, int((diff_g / 30) * 200))

    # Cizgileri daha dolgun ve parlak yapmak icin kalınlaştırma
    ...
    print(f'{filename} -> {out_filename} islendi!')

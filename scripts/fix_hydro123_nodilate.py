...
def process_hydro(filename, out_filename):
    ...
    for y in range(h):
        for x in range(w):
            ...
            # Cok daha kati bir cyan filtresi
            if diff_g > 50 and diff_b > 45:
                mp[x, y] = 255
            elif diff_g > 30 and diff_b > 30:
                mp[x, y] = 120

    # Max filter kaldirildi, cunku pencerelerdeki noktalari birlestirip bloga donusturuyor
